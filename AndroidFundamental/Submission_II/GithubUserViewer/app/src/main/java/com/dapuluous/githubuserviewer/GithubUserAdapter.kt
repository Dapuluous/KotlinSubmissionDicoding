...
class GithubUserAdapter(private val listUsers: ArrayList<GithubUser>) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.listName.text = user.name
        ...
        viewHolder.itemView.setOnClickListener {
            ...
            val intentDetail = Intent(mainContext, GithubUserDetail::class.java)
            intentDetail.putExtra(GithubUserDetail.EXTRA_PROFILE, dataUser)
